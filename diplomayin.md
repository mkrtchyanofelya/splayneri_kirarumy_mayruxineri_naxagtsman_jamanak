...
Կորի ցանկացած կետին համապատասխանում է \(\beta\) անկյուն։ Այդ կետում կորի կորության շառավիղը, այսինքն՝ կորության հակադարձը, որոշվում է հետևյալ բանաձևով․
...
Փոքր \(k\)-ի դեպքում կորն ավելի մոտ է կլոտոիդին, իսկ մեծ արժեքների դեպքում դառնում է ավելի «ուռուցիկ»։ Սա կարելի է մեկնաբանել հետևյալ կերպ․

- Երբ \(k\)-ն մեծ է, օրինակ՝ \(k = 0.4\) կամ \(k = 0.45\), սկզբում կորությունը շատ դանդաղ է աճում, և կորը երկար ժամանակ գրեթե ուղիղ գիծ է մնում։ Վերջում՝ շրջանի մոտ, կորությունը սկսում է շատ արագ աճել, և կորը կարծես «շտապում է» հասնել վերջնական շառավղին՝ կտրուկ ծռվելով։ Այդ դեպքում կորը ստանում է \(J\)-աձև տեսք։
...
$$
R_0 = A(\sin \beta_0)^{\frac{1-k}{k}}, \qquad L = Ak\beta_0
$$
