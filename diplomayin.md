...
- Երբ \(k\)-ն փոքր է (օրինակ՝ \(k = 0.15\) կամ \(k = 0.2\)), սկզբում կորությունն ավելի արագ է սկսում աճել, սակայն կորության փոփոխությունը բաշխվում է ավելի հավասարաչափ ամբողջ կորի վրա, և կորը ստանում է ավելի հարթ ու բնական տեսք։
